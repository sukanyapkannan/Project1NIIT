...
body
{
  background-image: url("${pageContext.request.contextPath}/resources/backgd.jpeg");
				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="${pageContext.request.contextPath}/resources/images/${p.id}.jpg" /></div>
					...
					<div class="details col-md-6">
						...
						<h5 class="price">Available Stock : <span>${p.quantity}</span></h4>
