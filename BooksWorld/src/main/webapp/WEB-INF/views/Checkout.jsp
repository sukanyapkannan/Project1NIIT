            ...
            <div id='mainContentWrapper'>
                ...
                <c:forEach var="c" items="${Cart}">
                    <tr>
                        ...
                        <div class="media">
                            <a class="thumbnail pull-left" href="#"><img class="media-object" src="${pageContext.request.contextPath}/resources/images/${c.product.id}.jpg" style="width: 72px; height: 72px;"> </a>
